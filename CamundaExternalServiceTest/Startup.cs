...
using CamundaExternalServiceTest.Handlers;
...
namespace CamundaExternalServiceTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCamundaWorker("externalTest")
                .AddHandler<ExternalTestHandler>() // указываем Handler для обработки запроса
